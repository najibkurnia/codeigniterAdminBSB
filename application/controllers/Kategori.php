...
class Kategori extends CI_Controller
{
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->update($this->input->post('idKategori', TRUE));
        } else {
            $data = array(
		'namaKategori' => $this->input->post('namaKategori',TRUE),
	    );

            $this->Kategori_model->update($this->input->post('idKategori', TRUE), $data);
	...
	xlsWriteLabel($tablehead, $kolomhead++, "NamaKategori");
	...
	foreach ($this->Kategori_model->get_all() as $data) {
	    ...
	    xlsWriteLabel($tablebody, $kolombody++, $data->namaKategori);
    ...
    public function word()
    {
        ...
        $this->template->load('template','kategori/kategori_doc',$data);
    }
