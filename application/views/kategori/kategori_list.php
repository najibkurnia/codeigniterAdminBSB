    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('kategori/read/'.$kategori->idKategori),'Read'); 
				echo ' | '; 
				echo anchor(site_url('kategori/update/'.$kategori->idKategori),'Update'); 
				echo ' | '; 
				echo anchor(site_url('kategori/delete/'.$kategori->idKategori),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
